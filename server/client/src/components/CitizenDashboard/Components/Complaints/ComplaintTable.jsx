...
export default function ComplaintTable() {
	...
	return (
		<Section>
			<div className="table">
				<Table sty columns={columns} dataSource={data[0]?.body} pagination={pagination} loading={loading} />
			</div>
			<Drawer
			...
			<Modal title="Complaint Details" visible={isView} onCancel={() => setIsView(false)} onOk={() => setIsView(false)}>
				...
				<Input value={viewData?.complainantname} disabled />
				<Typography>Complaint</Typography>
				<Input value={viewData?.complaint} disabled />
				<Typography>Address</Typography>
				<Input value={viewData?.address} disabled />
				<Typography>Municipal</Typography>
				<Input value={viewData?.municipal} disabled />
				<Typography>Time and Date</Typography>
				<Input value={viewData?.timeAndDate} disabled />
				<Typography>Witness</Typography>
				<Input value={viewData?.witness} disabled />
				<Typography>Victim</Typography>
				<Input value={viewData?.victim} disabled />
				<Typography>Suspect</Typography>
				<Input value={viewData?.suspect} disabled />
